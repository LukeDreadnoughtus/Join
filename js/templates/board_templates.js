/**
 * Renders a template indicating that there are no tasks in any board column.
...
/**
 * Generates and appends a task card to the corresponding board column.
 * Displays task title, description, category, priority, subtasks progress, and assigned users.
 * @param {Object} taskData - The data object for the task, including:
 *   - id: string - Unique task ID
 *   - title: string - Task title
 *   - description: string - Task description
 *   - category: string - Task category
 *   - categoryColor: string - Color code or identifier for the category
 *   - priority: string - Priority level of the task
 *   - boardSlot: string - ID of the board column element (e.g., 'todo', 'progress')
 *   - assignedUsers: Array<string> - List of assigned user names
 *   - assignedUserColors: Array<string> - Corresponding colors for assigned users
 ...
 * category, priority, due date, assigned users, and subtasks. Also includes edit and delete options.
 * @param {Object} taskData - The task data object containing all relevant properties:
 *   - id: string - Unique task ID
 *   - title: string - Task title
 *   - description: string - Task description
 *   - category: string - Task category
 *   - categoryColor: string - Color identifier for the category
 *   - priority: string - Task priority
 *   - duedate: string - Task due date
 *   - assignedUsers: Array<string> - List of assigned user names
 *   - boardSlot: string - Column ID for task placement
 *   - subtasksTotal: number - Total number of subtasks
 *   - subtasksDone: number - Number of completed subtasks
 */
...
/**
 * Renders the task edit overlay, allowing the user to edit task details including title,
 * description, due date, priority, assigned users, and subtasks.
 * Sets up the event listeners for subtasks and user dropdowns, and applies auto-grow for textareas.
 * @param {Object} taskData - The task data object containing all relevant properties:
 *   - id: string - Unique task ID
 *   - title: string - Task title
 *   - description: string - Task description
