...
/** @const {string} Firebase database path for tasks */
const ADD_TASK_PATH = "https://board-50cee-default-rtdb.europe-west1.firebasedatabase.app/";

/** @const {string} Firebase database path for user registration data */
const ADD_TASK_PATH_REGISTER = "https://joinregistration-d9005-default-rtdb.europe-west1.firebasedatabase.app/";

/** @type {number} Unique identifier counter for subtasks */
let subtaskUid = 0;

/** @const {string[]} Array of required field IDs that must be validated */
...
/** @const {number} Maximum number of subtasks allowed per task */
const MAX_SUBTASKS = 3;

/** @const {string[]} Array of color codes for user avatars */
const COLORS = [
  "#FF0000", "#00FF00", "#0000FF", "#FFFF00", "#00FFFF", "#FF00FF",
  "#8A2BE2", "#ff8800", "#0f8558", "#00afff", "#cd6839", "#f9c20cff",
];

/** @const {string} CSS class for hidden overlay elements */
const HIDDEN_CLASS = "overlay_hidden";

/** @const {string} CSS class for active overlay elements */
const ACTIVE_CLASS = "overlay_active";

/** @const {string} SVG markup for edit icon */
const editIcon = `
...
/** @const {string} SVG markup for delete icon */
const deleteIcon = `
